...
**Answer** Well the column names are very long for under News Release/News Item
...
**Answer** Possibly a time column, to designate the time the release occurred? I also think that a "type" column could be made... Because I see labels like "Media Advisory" "Statement..." "Appointments"
...
**Answer** I don't see any because this code is being used to locating all of the li tags in the html
...
**Answer** Its not a data frame, but, this is supposed to be showing us the press releases that are within all of the li tags... It is giving us a lot of context that we aren't necessarily looking for.
...
**Answer** It is the same thing we had in the code above... But, it is cleaned up and put in a dataframe

...
**Answer** Nevada has the largest percentage growth.
...
*Answer** Howard County has the highest median household income
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** It should be ACS or Margin of Error
...
Is the difference between Calvert and Montgomery significant? **Answer** No it is not
...
**Answer** Largest increases were Baltimore City and Allegany County... I do not recognize any decreases... Definitely some very minimal increases though. Caroline County is lowest.
...
**Answer** We could ask what were the top 3 high schools that had the highest enrollment percentages, with a household income of at least $ 45,000? It could be harder if we also asked them to create a new column based on household incomes $ 45k and higher, and then  $ 44,999 or lower...
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer** The average household income for high schools that have 40% or more graduates immediately enrolling in college is $ 69,252.72. The average household income for high schools that have 60% or more graduates immediately enrolling in college is $ 111,448.30.
...
**Task** What is another question you could ask of this data? **Answer** You could maybe ask to find out the average household income for high schools that have 80% or more graduates immediately enrolling in college. Then with that you could do further research to find out what schools those graduates went to and see if theres any interesting discoveries with that.

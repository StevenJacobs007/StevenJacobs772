...
# Assuming your data frame is called "md_gov_county"
# You can replace "Moore" with the actual name of the column in your dataframe

# Calculate the total number of votes for Moore
total_votes_moore <- sum(md_gov_county$Moore)

# Calculate Moore's percentage in each county
md_gov_county$Moore_Percentage <- (md_gov_county$Moore / total_votes_moore) * 100

# Print the total votes and percentage
cat("Total Votes for Moore:", total_votes_moore, "\n")
head(md_gov_county)  # Display the first few rows of the updated dataframe
...
```{r}
# Assuming you have already calculated the percentages as shown in the previous answer
# and your data frame is called "md_gov_county"

# Assign Moore's percentages back to the dataframe
md_gov_county$Moore_Percentage <- (md_gov_county$Moore / total_votes_moore) * 100

# Now, the "Moore_Percentage" column in the dataframe is updated with the percentages
...
**Answer** Describe the changes from the previous map: I see Maryland divided by three different shades of Green, and different shades of Blue...
...
**Answer** Describe the changes from the previous map: Now we have our counties labeled, along with their percentages?
...
https://datawrapper.dwcdn.net/vKFO0/1/
...
**Answer** ordering class count by term
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** class count is closer together by numerical value
...
**Answer** department is summarized in alphabetical order
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** gives us the total seat number this time
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** giving us the average number of seats, median number of seats and the term
...
**Answer** course with the largest number of seats
...
1.  A question Id have based on this data is how far back is it able to go in years?

2.  Another question I'd have is, can you put a subject tab in pertaining to the course? I notice it has department but what about subject?

3.  Another question I have is how different it would look if you implemented the course level... probably help find courses even quicker?
